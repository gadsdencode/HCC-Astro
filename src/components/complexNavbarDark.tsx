        ...
        <div className="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          <ul className="navbar-nav ms-md-auto  justify-content-end">
            <li className="nav-item d-xl-none ps-3 d-flex align-items-center">
              <a href="#" className="p-0 text-white nav-link" id="" title="blank">
            ...
            <li className="px-3 nav-item d-flex align-items-center">
              <a href="#" className="p-0 text-white nav-link" title="blank">
            ...
            <li className="nav-item dropdown pe-2 d-flex align-items-center">
              <a href="#" className="p-0 text-white nav-link" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false" title="blank">
            ...
            <li className="nav-item d-flex align-items-center ps-2">
              <a href="#" className="px-0 text-white nav-link font-weight-bold" title="blank"></a>
            </li>
            <li className="nav-item dropdown pe-2 d-flex align-items-center">
